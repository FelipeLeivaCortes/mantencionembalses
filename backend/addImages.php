...
//			$name		= $file["name"][$x];
		...
		if( !$error ){
			$DATA["ERROR"]		= false;
			$DATA["ERRNO"]		= "";
			$DATA["MESSAGE"]	= "Se han cargado todas las imagenes exitosamente";
		
		}else{
			$DATA["ERROR"]		= true;
			$DATA["ERRNO"]		= 84;
			$DATA["MESSAGE"]	= "Se ha producido un error al cargar una imagen. Comuníquese con el administrador";
