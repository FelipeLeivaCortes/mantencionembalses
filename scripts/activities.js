    ...
    $.ajax({
        ...
        success:        (response)=>{
            if( response.ERROR  === true ){
                ...
                document.getElementById("historyActivityBtn").onclick   = function(e){ 
                    activity.maintances();
                ...
                document.getElementById("editActivityBtn").onclick      = function(e){
                    ...
                    document.getElementById("btnConfirm").setAttribute("onclick", "editActivity(" + activity.id + ");");
...
function delActivity(id){
    ...
    setTimeout(()=>{
        if( activity.lastOperation ){
            document.getElementById("container:" + activity.id).remove();
        ...
        success:        (response)=>{
            if(response.ERROR){
                ...
                for(var i=0; i<response.COUNT; i++){
                    let comments    = response[i].comments == null ? "No Registra" : response[i].comments;
                ...
                document.getElementById("printPdfBtn").onclick  = function(e){
                    this.disabled   = true;
